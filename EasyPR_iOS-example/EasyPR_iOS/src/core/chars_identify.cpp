...
CharsIdentify::CharsIdentify() {
    LOAD_ANN_MODEL(ann_, SGGlobalEasyPRPath::kDefaultAnnPath);
    LOAD_ANN_MODEL(annChinese_, SGGlobalEasyPRPath::kChineseAnnPath);
    LOAD_ANN_MODEL(annGray_, SGGlobalEasyPRPath::kGrayAnnPath);

    kv_ = std::shared_ptr<Kv>(new Kv);
    kv_->load(SGGlobalEasyPRPath::kChineseMappingPath);
...
void CharsIdentify::LoadChineseModel(std::string path) {
    if (path != std::string(SGGlobalEasyPRPath::kChineseAnnPath)) {
